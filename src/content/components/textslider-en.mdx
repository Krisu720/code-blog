...
description: Slider with photos i texts as a banner.
---
...
const images: ImageWithComponent[] = [
  {
    element: (
      <CustomComponent>
        Discover new possibilities with our brand binoculars.
      </CustomComponent>
    ),
  ...
  },
  {
    element: (
      <CustomComponent>
        Deliver food with Uber Eats and earn money on your business.
      </CustomComponent>
    ),
  ...
  {
    element: (
      <CustomComponent>Rent equipment anywhere in the world.</CustomComponent>
    ),
  ...
  },
  {
    element: (
      <CustomComponent>
        Make your dreams come true with the help of our loan services.
      </CustomComponent>
    ),
